...
public interface TimesheetRepository extends CrudRepository<Timesheet, Integer> {
	...
	public List<Timesheet> getTimesheetsByMissionAndDate(@Param("emp")Employe employeDTO, @Param("mis")Mission mission, @Param("dateD")Date dateDebut,@Param("dateF")Date dateFin);
